<?php
/**
 * RealGym VC block Class Schedule.
 *
 * @author  Balcomsoft
 * @package RealgymCore
 * @version 1.0.0
...
if ( ! class_exists( 'Realgymcore_VC_Schedule' ) ) {
	/**
	 * RealGym shortcode class
	 *
	 * @return void
	 */
	class Realgymcore_VC_Schedule extends WPBakeryShortCode {
		/**
		 * Slug
		 *
		 * @var string
		...
		private function set_name() {
			$this->name_escaped = esc_html__( 'Single Class Schedule', 'realgymcore' );
		}
