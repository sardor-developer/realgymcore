...
if ( ! class_exists( 'Realgymcore_Classes_List_Widget' ) ) {
	/**
	 * Classes list Widget Class
	 *
	 * @return void
	 */
	class Realgymcore_Classes_List_Widget extends WP_Widget {
		/**
		 *  Constructor
		 */
		public function __construct() {
			parent::__construct(
				'realgymcore-classes-list-widget',
				esc_html__( 'Realgym Classes list', 'realgymcore' ),
				array( 'description' => esc_html__( 'Display Classes list as a Widget', 'realgymcore' ) )
			);
		}
		...
		public function form( $instance ) {
			if ( isset( $instance['title'] ) ) {
				...
				$title_escaped = esc_attr__( 'Classes list', 'realgymcore' );
			}
			?>
			<p>
	...
	new Realgymcore_Classes_List_Widget();
}
