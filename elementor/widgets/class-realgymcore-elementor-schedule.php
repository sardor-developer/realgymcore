<?php
/**
 * Realgymcore Elementor Schedule
 *
 * @author  Balcomsoft
 * @package Realgymcore
 * @version 1.0.0
...
if ( ! class_exists( 'Realgymcore_Elementor_Schedule' ) ) {
	/**
	 * Realgymcore shortcode class
	 *
	 * @return void
	 */
	class Realgymcore_Elementor_Schedule extends Widget_Base {
		/**
		 * Slug
		 *
		 * @var string
		 */
		protected $slug = 'realgymcore-elementor-schedule';
		/**
		 * Handler Stiles, Javascript files.
		 *
		 * @var string
		 */
		protected $handler = 'realgymcore-vc-schedule';
		/**
		 * Name escaped
		 *
		 * @var string
		...
		public function get_title() {
			return esc_html__( 'Single Class Schedule', 'realgymcore' );
		}
		...
		protected function render() {
			...
			echo do_shortcode( '[realgymcore-vc-schedule-shortcode ' . $arg_strings . ']' );

		}
	}

	\Elementor\Plugin::instance()->widgets_manager->register( new Realgymcore_Elementor_Schedule() );
