...
if ( ! class_exists( 'Realgymcore_Elementor_List' ) ) {
	/**
	 * Realgymcore shortcode class
	 *
	 * @return void
	 */
	class Realgymcore_Elementor_List extends Widget_Base {
		/**
		 * Slug
		 *
		 * @var string
		 */
		protected $slug = 'realgymcore-elementor-list';
		/**
		 * Handler Stiles, Javascript files.
		 *
		 * @var string
		 */
		protected $handler = 'realgymcore-vc-list';
		/**
		 * Name escaped
		 *
		 * @var string
		...
		public function get_title() {
			return esc_html__( 'List', 'realgymcore' );
		}
		...
		protected function render() {
			...
			echo do_shortcode( '[realgymcore-vc-list-shortcode ' . $arg_strings . ']' );

		}
	}

	\Elementor\Plugin::instance()->widgets_manager->register( new Realgymcore_Elementor_List() );
