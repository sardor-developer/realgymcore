<?php
/**
 * Realgymcore Elementor Heading Button
 *
 * @author  Balcomsoft
 * @package Realgymcore
 * @version 1.0.0
...
if ( ! class_exists( 'Realgymcore_Elementor_IconBox' ) ) {
	/**
	 * Realgymcore shortcode class
	 *
	 * @return void
	 */
	class Realgymcore_Elementor_IconBox extends Widget_Base {
		/**
		 * Slug
		 *
		 * @var string
		 */
		protected $slug = 'realgymcore-elementor-icon-box';
		/**
		 * Handler Stiles, Javascript files.
		 *
		 * @var string
		 */
		protected $handler = 'realgymcore-vc-icon-box';
		/**
		 * Name escaped
		 *
		 * @var string
		...
		public function get_title() {
			return esc_html__( 'Icon box', 'realgymcore' );
		}
		...
		protected function get_general_options() {
			...
			$this->add_control(
				'show_categories',
				array(
					'label'        => esc_html__( 'Show Categories', 'realgymcore' ),
		...
		protected function render() {
			...
			echo do_shortcode( '[realgymcore-vc-icon-box-shortcode ' . $arg_strings . ']' );

		}
	}

	\Elementor\Plugin::instance()->widgets_manager->register( new Realgymcore_Elementor_IconBox() );
