<?php
/**
 * Realgymcore Elementor Calculator
 *
 * @author  Balcomsoft
 * @package Realgymcore
 * @version 1.0.0
...
if ( ! class_exists( 'Realgymcore_Elementor_Calculator' ) ) {
	/**
	 * Realgymcore shortcode class
	 *
	 * @return void
	 */
	class Realgymcore_Elementor_Calculator extends Widget_Base {
		/**
		 * Slug
		 *
		 * @var string
		 */
		protected $slug = 'realgymcore-elementor-calculator';
		 ...
		 * @var string
		 */
		protected $handler = 'realgymcore-vc-calculator';
		...
		public function get_title() {
			return esc_html__( 'Calculator', 'realgymcore' );
		}
		...
		protected function render() {
			...
			echo do_shortcode( '[realgymcore-vc-calculator-shortcode ' . $arg_strings . ']' );
		}
	}

	\Elementor\Plugin::instance()->widgets_manager->register( new Realgymcore_Elementor_Calculator() );
