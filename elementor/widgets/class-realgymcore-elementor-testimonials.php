<?php
/**
 * Realgymcore Elementor Testimonials
 *
 * @author  Balcomsoft
 * @package Realgymcore
 * @version 1.0.0
...
if ( ! class_exists( 'Realgymcore_Elementor_Testimonials' ) ) {
	/**
	 * Realgymcore shortcode class
	 *
	 * @return void
	 */
	class Realgymcore_Elementor_Testimonials extends Widget_Base {
		/**
		 * Slug
		 *
		 * @var string
		 */
		protected $slug = 'realgymcore-elementor-testimonials';
		/**
		 * Handler Stiles, Javascript files.
		 *
		 * @var string
		 */
		protected $handler = 'realgymcore-vc-testimonials';
		/**
		 * Name escaped
		 *
		 * @var string
		...
		public function get_title() {
			return esc_html__( 'Testimonials', 'realgymcore' );
		}
		...
		protected function get_general_options() {
			...
			$this->add_control(
				'realgymcore_testimonials_slider',
				array(
					'label'   => esc_html__( 'Testimonials Slider Type', 'realgymcore' ),
					'type'    => \Elementor\Controls_Manager::SELECT,
					'default' => 'testimonials_slider_1',
					'options' => array(
						'testimonials_slider_1' => esc_html__( 'Testimonials Slider 1', 'realgymcore' ),
						'testimonials_slider_2' => esc_html__( 'Testimonials Slider 2', 'realgymcore' ),
					),
				)
			);
		...
		protected function render() {
			...
			echo do_shortcode( '[realgymcore-vc-testimonials-shortcode ' . $arg_strings . ']' );

		}
	}

	\Elementor\Plugin::instance()->widgets_manager->register( new Realgymcore_Elementor_Testimonials() );
