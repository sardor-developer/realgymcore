<?php
/**
 * Realgymcore Elementor Videos Grid
 *
 * @author  Balcomsoft
 * @package Realgymcore
 * @version 1.0.0
...
if ( ! class_exists( 'Realgymcore_Elementor_Videos' ) ) {
	/**
	 * Realgymcore shortcode class
	 *
	 * @return void
	 */
	class Realgymcore_Elementor_Videos extends Widget_Base {
		/**
		 * Slug
		 *
		 * @var string
		 */
		protected $slug = 'realgymcore-elementor-videos';
		/**
		 * Handler Stiles, Javascript files.
		 *
		 * @var string
		 */
		protected $handler = 'realgymcore-vc-videos';
		/**
		 * Name escaped
		 *
		 * @var string
		...
		public function get_title() {
			return esc_html__( 'Videos Grid', 'realgymcore' );
		}
		...
		protected function get_general_options() {
			...
			$this->add_control(
				'only_featured',
				array(
					'label'        => esc_html__( 'Only featured videos', 'realgymcore' ),
		...
		protected function render() {
			...
			echo do_shortcode( '[realgymcore-vc-videos-shortcode ' . $arg_strings . ']' );

		}
	}

	\Elementor\Plugin::instance()->widgets_manager->register( new Realgymcore_Elementor_Videos() );
